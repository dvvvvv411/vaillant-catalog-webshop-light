...
const HeroSection = () => <section className="py-4 bg-[#efefef]">
    <div className="container">
      <div className="relative h-[600px] overflow-hidden rounded-lg flex items-center" style={{
        backgroundImage: 'url(https://www.myvaillantpro.de/_next/image?url=https%3A%2F%2Fvaillantprod-media.e-spirit.cloud%2F5cd5b6c1-e1b5-4e7f-86dc-3c7e01bfe78f%2Fimportedmedia%2Ffachpartnernet-video_IMAGE_16_9.jpg&w=3840&q=75)',
        ...
        <div className="relative z-10 bg-white rounded-lg shadow p-6 md:p-8 mx-auto max-w-4xl">
          ...
          <div className="flex flex-col lg:flex-row items-center gap-8 min-h-[400px] relative">
